...
SRC = $(SRCIIO) $(SRCFFT) $(SRCGSL) $(SRCCXX)
...
$(addprefix $(BINDIR)/,$(SRCCXX)) : $(BINDIR)/% : $(SRCDIR)/%.cc $(SRCDIR)/iio.o
	$(CXX) $(CFLAGS) $(OFLAGS) $^ -o $@ $(IIOFLAGS)
