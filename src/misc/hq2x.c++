// code from https://pastebin.com/raw/YXpmqvW5
// cf. http://forums.nesdev.com/viewtopic.php?p=82770 (see byuu's post)
...
// pack rgb into contiguous bits
static uint16_t pack(uint32_t n) { n &= 0x03e07c1f; return n | (n >> 16); }

// unpack contiguous bits into separate bytes (so that arithmetic works)
