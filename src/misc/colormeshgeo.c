...
// TODO 1: extirpate main function into callable lib
// TODO 2: implement the following two functions without geographiclib
...
static void help(char *s)
{
	...
	// offset allows the user to choose the origin of the coordinate system,
