...
src/bdint.o: src/bdint.c src/abstract_dsf.c src/help_stuff.c src/iio.h \
  src/pickopt.c
...
src/blurd.o: src/blurd.c src/fail.c src/xmalloc.c src/smapa.h \
  src/help_stuff.c src/parsenumbers.c src/pickopt.c src/iio.h
src/bmms.o: src/bmms.c src/xmalloc.c src/fail.c src/getpixel.c src/iio.h \
  src/pickopt.c
src/carve.o: src/carve.c src/iio.h src/smapa.h
...
src/eucdist.o: src/eucdist.c src/iio.h src/pickopt.c
...
src/fancy_image.o: src/fancy_image.c src/fancy_image.h src/iio.h \
  src/xmalloc.c src/fail.c src/tiff_octaves_rw.c src/smapa.h
src/fft.o: src/fft.c src/iio.h src/fail.c src/xmalloc.c src/ppsmooth.c \
  src/pickopt.c
...
src/fontu.o: src/fontu.c src/xmalloc.c src/fail.c src/xfopen.c src/dataconv.c \
  src/fonts/xfonts_all.c src/fonts/xfont_4x6.c src/fonts/xfont_5x7.c \
  src/fonts/xfont_5x8.c src/fonts/xfont_6x10.c src/fonts/xfont_6x12.c \
  src/fonts/xfont_6x13.c src/fonts/xfont_6x13B.c src/fonts/xfont_6x13O.c \
  src/fonts/xfont_6x9.c src/fonts/xfont_7x13.c src/fonts/xfont_7x13B.c \
  src/fonts/xfont_7x13O.c src/fonts/xfont_7x14B.c src/fonts/xfont_8x13.c \
  src/fonts/xfont_8x13B.c src/fonts/xfont_8x13O.c src/fonts/xfont_9x15.c \
  src/fonts/xfont_9x15B.c src/fonts/xfont_9x18.c src/fonts/xfont_9x18B.c \
  src/fonts/xfont_10x20.c src/fonts/xfont_canny.c \
  src/fonts/xfont_clR6x12.c src/fonts/xfont_helvR12.c src/iio.h \
  src/pickopt.c
src/geomedian.o: src/geomedian.c src/linalg.c src/random.c src/pickopt.c \
...
src/gntiply.o: src/gntiply.c src/iio.h
src/gram_schmidt.o: src/gram_schmidt.c
src/grid.o: src/grid.c src/fail.c
src/heatd.o: src/heatd.c src/iio.h src/pickopt.c
...
src/imhalve.o: src/imhalve.c src/iio.h
...
src/lrcat.o: src/lrcat.c src/iio.h src/xmalloc.c src/fail.c src/getpixel.c \
  src/pickopt.c src/smapa.h src/help_stuff.c
...
src/palette.o: src/palette.c src/fail.c src/xmalloc.c src/xfopen.c \
  ...
  src/fonts/xfont_9x15B.c src/fonts/xfont_9x18.c src/fonts/xfont_9x18B.c \
  src/fonts/xfont_10x20.c src/fonts/xfont_canny.c \
  src/fonts/xfont_clR6x12.c src/fonts/xfont_helvR12.c src/help_stuff.c
...
src/rpc2.o: src/rpc2.c src/xfopen.c src/fail.c src/smapa.h
src/rpcfit33.o: src/rpcfit33.c
src/rpctk.o: src/rpctk.c src/xmalloc.c src/fail.c src/xfopen.c \
  src/parsenumbers.c src/rpcfit33.c src/rpc2.c src/smapa.h
...
src/synflow_core.o: src/synflow_core.c src/fail.c src/getpixel.c \
  ...
  src/smapa.h
src/tbcat.o: src/tbcat.c src/iio.h src/xmalloc.c src/fail.c src/getpixel.c \
  src/pickopt.c src/smapa.h src/help_stuff.c
...
src/upsa.o: src/upsa.c src/iio.h src/fail.c src/marching_squares.c \
  src/marching_interpolation.c src/bicubic.c src/getpixel.c \
  src/pickopt.c
...
src/warp.o: src/warp.c src/iio.h src/fail.c src/xmalloc.c src/getpixel.c \
  src/bicubic.c src/smapa.h
src/xfopen.o: src/xfopen.c src/fail.c
src/xmalloc.o: src/xmalloc.c src/fail.c
src/ftr/bilinear_interpolation.o: src/ftr/bilinear_interpolation.c
...
src/ftr/cloudette.o: src/ftr/cloudette.c src/ftr/ftr.h src/ftr/iio.h \
  src/ftr/fontu.c src/ftr/xmalloc.c src/ftr/fail.c src/ftr/xfopen.c \
  src/ftr/dataconv.c src/ftr/fonts/xfonts_all.c \
  ...
  src/ftr/pickopt.c
src/ftr/colorcoordsf.o: src/ftr/colorcoordsf.c
...
src/ftr/fancy_image.o: src/ftr/fancy_image.c src/ftr/fancy_image.h src/ftr/iio.h \
  ...
  src/ftr/smapa.h
src/ftr/fancy_rpcflip.o: src/ftr/fancy_rpcflip.c src/ftr/rpc2.c src/ftr/xfopen.c \
  src/ftr/fail.c src/ftr/smapa.h src/ftr/ftr.h src/ftr/ccpu.h \
  src/ftr/fancy_image.h src/ftr/srtm4o.c src/ftr/tiff_octaves_rw.c \
  src/ftr/iio.h src/ftr/xmalloc.c src/ftr/fontu.c src/ftr/dataconv.c \
  src/ftr/fonts/xfonts_all.c src/ftr/fonts/xfont_4x6.c \
  src/ftr/fonts/xfont_5x7.c src/ftr/fonts/xfont_5x8.c \
  src/ftr/fonts/xfont_6x10.c src/ftr/fonts/xfont_6x12.c \
  src/ftr/fonts/xfont_6x13.c src/ftr/fonts/xfont_6x13B.c \
...
src/ftr/fauxfilet.o: src/ftr/fauxfilet.c src/ftr/ftr.h src/ftr/fontu.c \
  src/ftr/xmalloc.c src/ftr/fail.c src/ftr/xfopen.c src/ftr/dataconv.c \
  src/ftr/fonts/xfonts_all.c src/ftr/fonts/xfont_4x6.c \
  src/ftr/fonts/xfont_5x7.c src/ftr/fonts/xfont_5x8.c \
  src/ftr/fonts/xfont_6x10.c src/ftr/fonts/xfont_6x12.c \
  ...
  src/ftr/fonts/xfont_9x18B.c src/ftr/fonts/xfont_10x20.c \
  src/ftr/fonts/xfont_canny.c src/ftr/fonts/xfont_clR6x12.c \
  src/ftr/fonts/xfont_helvR12.c src/ftr/pickopt.c src/ftr/help_stuff.c
...
src/ftr/lles.o: src/ftr/lles.c src/ftr/ftr.h src/ftr/seconds.c src/ftr/random.c \
  src/ftr/bilinear_interpolation.c src/ftr/fontu.c src/ftr/xmalloc.c \
  src/ftr/fail.c src/ftr/xfopen.c src/ftr/dataconv.c \
  src/ftr/fonts/xfonts_all.c src/ftr/fonts/xfont_4x6.c \
  src/ftr/fonts/xfont_5x7.c src/ftr/fonts/xfont_5x8.c \
...
src/ftr/mathieu.o: src/ftr/mathieu.c src/ftr/ftr.h src/ftr/fontu.c \
  src/ftr/xmalloc.c src/ftr/fail.c src/ftr/xfopen.c src/ftr/dataconv.c \
  src/ftr/fonts/xfonts_all.c src/ftr/fonts/xfont_4x6.c \
  src/ftr/fonts/xfont_5x7.c src/ftr/fonts/xfont_5x8.c \
  src/ftr/fonts/xfont_6x10.c src/ftr/fonts/xfont_6x12.c \
...
src/ftr/pkatz.o: src/ftr/pkatz.c src/ftr/ftr.h src/ftr/fontu.c src/ftr/xmalloc.c \
  ...
  src/ftr/fonts/xfont_9x18B.c src/ftr/fonts/xfont_10x20.c \
  src/ftr/fonts/xfont_canny.c src/ftr/fonts/xfont_clR6x12.c \
  src/ftr/fonts/xfont_helvR12.c src/ftr/parsenumbers.c
...
src/ftr/rpc2.o: src/ftr/rpc2.c src/ftr/xfopen.c src/ftr/fail.c src/ftr/smapa.h
...
src/ftr/vac.o: src/ftr/vac.c src/ftr/ftr.h src/ftr/iio.h src/ftr/fontu.c \
  src/ftr/xmalloc.c src/ftr/fail.c src/ftr/xfopen.c src/ftr/dataconv.c \
  src/ftr/fonts/xfonts_all.c src/ftr/fonts/xfont_4x6.c \
  src/ftr/fonts/xfont_5x7.c src/ftr/fonts/xfont_5x8.c \
  src/ftr/fonts/xfont_6x10.c src/ftr/fonts/xfont_6x12.c \
  ...
  src/ftr/fonts/xfont_9x18B.c src/ftr/fonts/xfont_10x20.c \
  src/ftr/fonts/xfont_canny.c src/ftr/fonts/xfont_clR6x12.c \
  src/ftr/fonts/xfont_helvR12.c src/ftr/random.c src/ftr/blur.c \
  src/ftr/smapa.h src/ftr/ppsmooth.c src/ftr/pickopt.c \
  src/ftr/help_stuff.c
...
src/ftr/vpoints.o: src/ftr/vpoints.c src/ftr/ftr.h src/ftr/iio.h src/ftr/fontu.c \
  src/ftr/xmalloc.c src/ftr/fail.c src/ftr/xfopen.c src/ftr/dataconv.c \
  src/ftr/fonts/xfonts_all.c src/ftr/fonts/xfont_4x6.c \
  src/ftr/fonts/xfont_5x7.c src/ftr/fonts/xfont_5x8.c \
  src/ftr/fonts/xfont_6x10.c src/ftr/fonts/xfont_6x12.c \
  ...
  src/ftr/fonts/xfont_9x18B.c src/ftr/fonts/xfont_10x20.c \
  src/ftr/fonts/xfont_canny.c src/ftr/fonts/xfont_clR6x12.c \
  src/ftr/fonts/xfont_helvR12.c src/ftr/random.c src/ftr/pickopt.c \
  src/ftr/help_stuff.c
src/ftr/vstab.o: src/ftr/vstab.c src/ftr/ftr.h src/ftr/iio.h src/ftr/fontu.c \
  src/ftr/xmalloc.c src/ftr/fail.c src/ftr/xfopen.c src/ftr/dataconv.c \
  src/ftr/fonts/xfonts_all.c src/ftr/fonts/xfont_4x6.c \
  src/ftr/fonts/xfont_5x7.c src/ftr/fonts/xfont_5x8.c \
  src/ftr/fonts/xfont_6x10.c src/ftr/fonts/xfont_6x12.c \
...
src/ftr/wifpan.o: src/ftr/wifpan.c src/ftr/iio.h src/ftr/ftr.h src/ftr/fontu.c \
  ...
  src/ftr/fonts/xfont_9x18B.c src/ftr/fonts/xfont_10x20.c \
  src/ftr/fonts/xfont_canny.c src/ftr/fonts/xfont_clR6x12.c \
  src/ftr/fonts/xfont_helvR12.c src/ftr/blur.c src/ftr/smapa.h \
  src/ftr/ppsmooth.c
...
src/misc/closeup.o: src/misc/closeup.c src/misc/iio.h src/misc/marching_squares.c \
  src/misc/marching_interpolation.c src/misc/bicubic.c \
  src/misc/getpixel.c
...
src/misc/colormeshg.o: src/misc/colormeshg.c src/misc/iio.h src/misc/fail.c \
  src/misc/rpc.c src/misc/xfopen.c src/misc/smapa.h \
  src/misc/parsenumbers.c src/misc/xmalloc.c src/misc/pickopt.c
src/misc/colormeshgeo.o: src/misc/colormeshgeo.c src/misc/iio.h src/misc/fail.c \
  src/misc/rpc.c src/misc/xfopen.c src/misc/smapa.h \
  src/misc/parsenumbers.c src/misc/xmalloc.c src/misc/pickopt.c
...
src/misc/fancy_image.o: src/misc/fancy_image.c src/misc/fancy_image.h \
  ...
  src/misc/tiff_octaves_rw.c src/misc/smapa.h
...
src/misc/fft.o: src/misc/fft.c src/misc/iio.h src/misc/fail.c src/misc/xmalloc.c \
  src/misc/ppsmooth.c src/misc/pickopt.c
...
src/misc/geomedian.o: src/misc/geomedian.c src/misc/linalg.c src/misc/random.c \
  src/misc/pickopt.c src/misc/iio.h src/misc/help_stuff.c
...
src/misc/hslice.o: src/misc/hslice.c src/misc/iio.h
...
src/misc/iminfo.o: src/misc/iminfo.c src/misc/iio.h src/misc/statistics.c \
  src/misc/fail.c src/misc/xmalloc.c
src/misc/imsort.o: src/misc/imsort.c src/misc/iio.h
...
src/misc/lgblur3.o: src/misc/lgblur3.c src/misc/gblur.c src/misc/iio.h \
  src/misc/fail.c src/misc/xmalloc.c src/misc/vvector.h \
  src/misc/bicubic.c src/misc/getpixel.c src/misc/smapa.h
src/misc/lic.o: src/misc/lic.c src/misc/fail.c src/misc/xmalloc.c \
  ...
  src/misc/iio.h
src/misc/linalg.o: src/misc/linalg.c
...
src/misc/lowe_join.o: src/misc/lowe_join.c
...
src/misc/mnehs_ms.o: src/misc/mnehs_ms.c src/misc/iio.h src/misc/xmalloc.c \
  src/misc/fail.c src/misc/getpixel.c src/misc/bicubic.c \
  src/misc/smapa.h src/misc/parsenumbers.c src/misc/pickopt.c
...
src/misc/neumann_inpainting.o: src/misc/neumann_inpainting.c src/misc/smapa.h \
  src/misc/iio.h
...
src/misc/paraflow.o: src/misc/paraflow.c src/misc/iio.h src/misc/fail.c \
  ...
  src/misc/getpixel.c src/misc/marching_interpolation.c \
  src/misc/vvector.h src/misc/homographies.c src/misc/smapa.h
...
src/misc/segfilter.o: src/misc/segfilter.c src/misc/parsenumbers.c \
  src/misc/xmalloc.c src/misc/fail.c src/misc/iio.h
...
src/misc/zoombil.o: src/misc/zoombil.c src/misc/fail.c src/misc/xmalloc.c \
  src/misc/bilinear_interpolation.c src/misc/bicubic.c \
  src/misc/getpixel.c src/misc/smapa.h src/misc/iio.h src/misc/pickopt.c
